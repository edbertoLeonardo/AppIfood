...
import br.com.leonardo.meuifood.adapter.AdapterProduto;
...
import br.com.leonardo.meuifood.model.ItemPedido;
...
public class CardapioActivity extends AppCompatActivity {
    ...
    private EditText textCarrinhoQtd, textCarrinhoTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( bundle != null ){
            ...
            String url = empresaSelecionada.getUtlImagem();
          ...
          public void onDataChange(@NonNull DataSnapshot snapshot) {
              ...
              if (snapshot.getValue() != null){
                  ...
                  for (ItemPedido itemPedido: itensCarrinho){
                      ...
                      quantidadeItensCarrinho += quantidade;
                  }

              }
              DecimalFormat df = new DecimalFormat("0.00");

              textCarrinhoQtd.setText("quantidade: "+ String.valueOf(quantidadeItensCarrinho));
              textCarrinhoTotal.setText("Total R$: " + df.format(totalCarrinho));
    ...
    private void confirmarPedido() {
        ...
        builder.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String observcao = editObservacao.getText().toString();
                pedidoRecuperado.setMetodoPagamento(metodoPagamento);
                pedidoRecuperado.setObservacao(observcao);
